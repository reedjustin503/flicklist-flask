...
def add_movie():
    ...
    if new_movie == '':
        return redirect("/?error=Please specify the name of the movie you want to add")
    ...
    for movie in terrible_movies:
        if movie == new_movie:
            ...
            return redirect("/?error=Trust me, you don't want to add {0} to your Watchlist.".format(new_movie))
